...
# surveys neu
create_table = "CREATE TABLE IF NOT EXISTS surveys (surveyid TEXT, serviceprovider TEXT, surveyname TEXT, status TEXT, comment TEXT, questions TEXT)"
cursor.execute(create_table)
...
cursor.execute("INSERT INTO items VALUES ('test', 1333)")
# test surveys
