...
from resources.parsers import check_status, check_survey_questions
...
class Survey(Resource):
    ...
    def post(self, surveyname):
        ...
        if not check_survey_questions(questionlist):
            return {'message': "Data not valid: please check 'qid', 'name','type' and 'options'."}, 400 #bad request
