...
from internal.create_summaries import counting_histogram_values, extract_from_surveys, extract_from_reports


class CreateSummaries(Resource):
    '''
    TODO: only works with given qid
    '''
    ...
    def get(self,surveyid):
        ...
        return {'message': " summary for surveyid '{}' is sucessfully created.".format(surveyid)}, 200 #ok
